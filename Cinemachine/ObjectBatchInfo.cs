...
namespace lLCroweTool.Cinemachine
{
    ...
    public class ObjectBatchInfo : MonoBehaviour
    {
        ...
        public bool ActionBatchInfoCamera(float timer)
        {
            ...
            float norValue = Util.MinMaxNormalize(startTime, endTime, timer);
            ...
            switch (movePosType)
            {
                ...
                case MovePosType.Bezier:                    
                    ...
                    resultPos.x = Util.FourPointBezier(startPos.x, startHandlePos.x, endHandlePos.x, endPos.x, curveValue);
                    resultPos.y = Util.FourPointBezier(startPos.y, startHandlePos.y, endHandlePos.y, endPos.y, curveValue);
                    resultPos.z = Util.FourPointBezier(startPos.z, startHandlePos.z, endHandlePos.z, endPos.z, curveValue);
